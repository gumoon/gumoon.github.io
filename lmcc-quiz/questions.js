const QUESTIONS = [
  ...
  {
    "question": "与图像数据（Image）相比，自然语言在作为大模型输入数据时，最显著的物理特征区别是：",
    "options": {
  ...
  },
  {
    ...
    "blanks": [
      ...
      {
        "answer": "auto_prompt_generator",
        "alternatives": [
          "generate_prompt"
        ]
      }
    ],
    "explanation": "填空 1：generate（或 predict/invoke/call）是调用大模型生成文本的标准方法。\n填空 2：auto_prompt_generator（或 generate_prompt）是递归调用自身，根据反馈迭代优化提示词。自动化提示设计的核心是利用 LLM 作为\"优化器\"，根据执行反馈自动迭代 Prompt。",
    "category": "提示学习",
    "group": "adult"
  },
  {
